...
window.TEXTOS_EFECTOS = {
  'madrid': {
    tituloEscena: 'Hacemos un date romántica? Carlos y Bea en la cita romántica:',   // Título de la escena
    ...
    adMarca: 'LOS DEL VERMUT™',   // Anuncio · marca
    ...
    parejaCaption2: '',   // Oasis · pie foto 2
    parejaCaption3: '',   // Oasis · pie foto 3
  },
  'cordoba': {
  ...
  'berlin': {
    cancion1: 'Normal',   // Setlist · canción 1
    cancion2: 'Joderse la vida',   // Setlist · canción 2
    cancion3: 'Misil',   // Setlist · la nuestra
    cancion4: 'Verdes, césped',   // Setlist · bis
    captionConcierto: 'Ni una me sabía pero como lo pasamos ',   // Pie del vídeo
  },
  'praga': {
  ...
  'estambul-capadocia': {
    camaCaption: 'Alguna ventaja tienen que tener los organizadores',   // La cama · pie
    topkapiTitulo: 'El momento en el que Bea dice que se enamoró de mí',   // Topkapi · título
    topkapiEl: 'Pues había hombres que les cortaban el pene',   // Topkapi · él dice
    topkapiElSub: 'Me hacía el listillo...',   // Topkapi · él (línea pequeña)
    topkapiElla: 'espera… ¿les hacían QUÉ?',   // Topkapi · ella dice
    topkapiEllaSub: 'es el amor de mi vida...',   // Topkapi · ella (línea pequeña)
    topkapiCaption: 'lo que ella no sabía es que todo era gracias a juego de tronos...',   // Topkapi · pie
  },
};

/* ============================================================
   Estambul–Capadocia — contenido de la página
   ✏️ EDITA AQUÍ: fechas, textos y captions.
   La media va en /assets/destinos/estambul-capadocia/ con estos nombres:
   hero.jpg (o hero.mp4 cambiando type a 'video'), foto-1.jpg…
   Busca "EDITAR" para ver todos los huecos.
   ============================================================ */

window.DESTINO_DATA = {
  slug: 'estambul-capadocia',
  titulo: 'Estam<em>bul</em> &amp; Capadocia',
  fechas: '\u2039\u2039 FECHAS \u2014 EDITAR \u203a\u203a \u00b7 p. ej. \u00abmarzo 2026\u00bb',

  intro: '\u2039\u2039 INTRO \u2014 EDITAR \u203a\u203a \u2014 Globos al amanecer, un hotel-cueva y la cama más grande de nuestra historia.',

  hero: { type: 'img', src: 'hero.jpg' },  // cambia a { type:'video', src:'hero.mp4' } si es video

  galeriaSub: 'amaneceres que no parecían de verdad',
  galeria: [
  ...
  historia: '\u2039\u2039 HISTORIA \u2014 EDITAR \u203a\u203a \u2014 Aqu\u00ed va nuestra an\u00e9cdota de Estambul–Capadocia: c\u00f3mo empez\u00f3, qu\u00e9 sali\u00f3 (m\u00e1s o menos) seg\u00fan el plan y qu\u00e9 no olvidaremos.',

  nota: '‹‹ INSIDE JOKE — EDITAR ›› <br>(LA. CAMA.)',
};

...
window.DESTINO_DATA = {
  ...
  intro: '‹‹ INTRO — EDITAR ›› — Atlántico bravo, bruma, pulpo y una gaviota con antecedentes penales.',

  hero: { type: 'img', src: 'hero.jpg' },  // cambia a { type:'video', src:'hero.mp4' } si es video

  galeriaSub: 'documentos gráficos del atraco',
  galeria: [
  ...
  historia: '‹‹ HISTORIA — EDITAR ›› — Aquí va nuestra anécdota de Vigo: cómo empezó, qué salió (más o menos) según el plan y qué no olvidaremos.',

  nota: '‹‹ INSIDE JOKE — EDITAR ›› <br>(la gaviota sigue en búsqueda y captura)',
};

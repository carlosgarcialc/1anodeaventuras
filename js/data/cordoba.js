...
window.DESTINO_DATA = {
  ...
  galeria: [
    { type: 'img', src: 'foto-6.jpg', caption: 'Solo me acuerdo de la tortilla de después' },
    { type: 'img', src: 'foto-1.jpg', caption: 'Quien lo diría con lo guapos que estamos', horizontal: true },
    { type: 'img', src: 'foto-7.jpg', caption: 'Y el carácter palentino volvió a hacerse con el control de la ciudad' },
    ...
    { type: 'img', src: 'foto-8.jpg', caption: 'Un Jagger siempre ayuda a emporerarse', horizontal: true },
  ...
  historia: 'Córdoba a parte de ser muy divertido, nos enseñó mucho. Creo que nuestro primer día en Córdoba es de mis días favoritos juntos, ¿tu te acuerdas lo que nos reímos? Todo el día con chorradas, diciendo tonterías sin parar contigo a solas, y no necesitaba nada más. Fue de esos días que mientras estaba viviendo me sentía completamente afortunado, y mira que el contexto no era genial (Córdoba en junio) pero tu lo haces todo divertido y entretenido. También tuvimos ahí por el medio un día de bajoncillo; malos entendidos, malas actitudes y poca comunicación pero no hay que olvidarlo, una relación también es eso. Y tanto que aprendimos, porque el tercero volvió a ser absolutamente espectacular. Y lo que nos apoyamos y reímos durante la travesía por el desierto ese día. Por cierto menos mal que cogimos el apartamento con terraza. Épico.',

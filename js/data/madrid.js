...
window.DESTINO_DATA = {
  ...
  intro: '\u2039\u2039 INTRO \u2014 EDITAR \u203a\u203a \u2014 Helado de fresa y limón, atardecer de ciudad y el principio de todo.',

  hero: { type: 'img', src: 'hero.jpg' },  // cambia a { type:'video', src:'hero.mp4' } si es video

  galeriaSub: 'fresa, limón y cero remordimientos',
  galeria: [
  ...
  nota: '‹‹ INSIDE JOKE — EDITAR ›› <br>(aquí va lo del helado… tú ya sabes)',
};
